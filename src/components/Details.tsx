      ...
      <div className="scroll-reveal max-w-3xl mx-auto text-center">
        ...
        <div className="mt-12 space-y-6">
          {schedule.map((item, i) => (
            <div
              key={i}
              className="flex items-center gap-3 sm:gap-6 p-4 sm:p-6 border border-gold/10 bg-cream/60 backdrop-blur-sm hover:border-gold/30 transition-all duration-300 group"
            >
